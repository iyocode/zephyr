...
static int pcal6408a_reset_state_apply(const struct i2c_dt_spec *i2c)
{
	...
	static const uint8_t reset_state[][2] = {
		...
		{PCAL6408A_REG_OUTPUT_DRIVE_STRENGTH_0, (CONFIG_GPIO_PCAL6408A_DRIVE_STRENGTH_BYTES & 0xff)},
		{PCAL6408A_REG_OUTPUT_DRIVE_STRENGTH_1, ((CONFIG_GPIO_PCAL6408A_DRIVE_STRENGTH_BYTES >> 8) & 0xff)},
